 ...
 * Description:       Passwordless login with passkeys (WebAuthn). Nothing to configure, no external service, and password sign-in keeps working.
 * Version:           0.13.79
...
define( 'RAPLS_PASSKEY_VERSION', '0.13.79' );
